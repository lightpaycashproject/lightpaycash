...
/** Utility functions used by the LightPayCash Qt UI.
 */
namespace GUIUtil
{
...
// Render LightPayCash addresses in monospace font
...
// Parse "lightpaycash:" URI into recipient object, return true on successful parsing
