                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LightPayCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LightPayCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lightpaycash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LightPayCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about LightPayCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LightPayCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LightPayCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LightPayCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a LightPayCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LightPayCash Core help message to get a list with possible LightPayCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LightPayCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LightPayCash network", "", count));
}
...
{
    QString strTitle = tr("LightPayCash Core"); // default title
