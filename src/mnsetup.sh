...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='lightpaycash.conf'
CONFIGFOLDER='/root/.lightpaycash'
COIN_DAEMON='lightpaycashd'
COIN_CLI='lightpaycash-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/lightpaycashproject/lightpaycash'
COIN_TGZ=''
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='LightPayCash - The P2P Money printer.Now with 2 addresses'
COIN_PORT=23563 #Updated Port
RPC_PORT=23352
...
function ask_permission() {
 echo -e "${RED}I trust LightPayCash and want to use$ $COIN_NAME binaries compiled on his server.${NC}."
...
function important_information() {
 ...
 echo -e "Please check ${RED}$COIN_NAME${NC} is running with the following command: ${RED}systemctl status $COIN_NAME.service${NC}"
  echo -e "Hope you enjoy the p2p cashprinter mn ,thanks for using the script"
 echo -e "================================================================================================================================"
}
