...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LightPayCash Core lightpaycash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lightpaycash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lightpaycash transaction") + "\n" +
                               "  lightpaycash-tx [options] -create [commands]   " + _("Create hex-encoded lightpaycash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lightpaycash transaction
