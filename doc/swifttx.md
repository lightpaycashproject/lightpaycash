...
This mechanism has been integrated into Bitcore-Node-LightPayCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LightPayCash-Project/insight-api-lightpaycash#web-socket-api](https://github.com/LightPayCash-Project/insight-api-lightpaycash#web-socket-api) 
* API: [https://github.com/LightPayCash-Project/insight-api-lightpaycash#swifttx-transactions](https://github.com/LightPayCash-Project/insight-api-lightpaycash#swifttx-transactions) 
...
By default, the LightPayCash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LightPayCash Core daemon:
