...
In order to support loading of multiple wallets in lightpaycash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lightpaycash.cpp.
...
Changes to lightpaycash.cpp
----------------------
lightpaycash.cpp is the entry point into lightpaycash-qt, and as such, will require some minor modifications to provide hooks for
